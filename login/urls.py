...
from mcdo import views as mcdo_views
...
urlpatterns = [
   ...
   #daily
    ...
    #mcdo (monthly reports)
    path('mcdo/', mcdo_views.home, name='mcdo-home'),
    path('entries/', mcdo_views.disp, name='mcdo-entries'),    
    path('search/', mcdo_views.search, name='search'), 
    path('enter/', mcdo_views.enter, name='mcdo-enter'),
    path('enter/<int:r_en>/', mcdo_views.enter, name='mcdo-enter'),
    path('enter_verify/', mcdo_views.enter_verify, name='enter_verify'),
    path('enter_verify/<int:r_en>/', mcdo_views.enter_verify, name='enter_verify'),
    path('approval/', mcdo_views.approval, name='mcdo-approval'),
    path('approve_action/<int:r_en>/<int:emp_id>', mcdo_views.approve_action, name='approve_verify'),
    
    # Verification function for Entry of Approving Authority.
    path('entry-verify/', mcdo_views.entry_verify, name='approval-entry-verify'),

    # Redirects to main home directly from the mcdo-module
    path('mainhome', mcdo_views.takemehome, name='takemehome')	
